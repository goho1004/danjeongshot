...
export default function TermsPage() {
  return (
    <LegalShell title="이용약관">
      ...
      <section>
        <h2 className="text-base font-semibold text-ink-950">4. 제공 개시 · 환불 · 품질</h2>
        <p className="mt-2">
          결제는 컷 생성·제공에 대한 의사표시이며, <strong>컷 생성이 성공</strong>하여 화면에
          표시되거나 파일이 전달·저장 가능한 상태가 되면{" "}
          <strong>디지털콘텐츠 제공이 개시</strong>된 것으로 봅니다. 화면 저장·캡처·촬영도 제공
          개시 이후의 이용으로 봅니다. <strong>환불</strong>은 시스템 결함으로 제품(파일)이
          전달되지 못한 경우에만 검토하며, <strong>품질</strong>(안닮·분위기 등)은 환불 사유가
          아니고 받기 전 다시 만들기·A/S로 안내합니다. 상세는 「환불·청약철회」 정책이 우선합니다.
        </p>
      </section>
